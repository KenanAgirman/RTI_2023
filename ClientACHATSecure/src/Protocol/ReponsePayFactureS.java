...
public class ReponsePayFactureS implements Reponse {
    ...
    public ReponsePayFactureS(boolean v, boolean e, SecretKey cleSession) throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, IOException {
        valide = v;
        echec = e;
